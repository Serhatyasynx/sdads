...
bot.guilds.cache.get("934726012099498005").channels.cache.get("934726012099498005").send(embed);
}
exports.conf = {
  enabled: true,
  guildOnly: false,
